...
//             <div className="w-full sm:flex gap-2 shadow-xl p-4 border">
...
//                 />
//                 <div className="absolute h-[50px] w-auto bottom-0 flex justify-center items-center gap-2">
//                   <div className="flex justify-around items-center gap-4 bg-gray-200 py-2 px-4 rounded-md">
//                     <p>-</p>
//                     <p>1</p>
//                     <p>+</p>
//                   </div>
...
//                 Urban Utility
//               </h2>
//               {/* <h2 className="text-2xl font-bold text-gray-800">BHJJ</h2> */}
//               <p className="text-xl font-normal text-gray-700">
//                 Trendy Men's Sunglasses, Stylish Shades with UV & Polarized for
//                 Sports, Fashionable Eyewear in Dubai, Goggles for Blocking,
//                 Retro Square Cycling Sunglass with Blue Lens - Latest in Fashion
//                 Online UAE
//               </p>
...
//                         class="p-1.5 border border-gray-200 rounded-full transition-all duration-300 hover:border-emerald-500 :border-emerald-500"
//                       >
//                         <svg
//                           width="15"
//                           height="15"
...
//                         </svg>
//                       </button>
//                       <button class="p-1.5 border border-gray-200 rounded-full transition-all duration-300 hover:border-amber-400 focus-within:border-amber-400">
//                         <svg
//                           width="15"
//                           height="15"
//                           viewBox="0 0 40 40"
...
//                         </svg>
//                       </button>
//                       <button class="p-1.5 border border-gray-200 rounded-full transition-all duration-300 hover:border-red-500 focus-within:border-red-500">
//                         <svg
//                           xmlns="http://www.w3.org/2000/svg"
//                           width="15"
//                           height="15"
...
//                         </svg>
//                       </button>
//                       <button class="p-1.5 border border-gray-200 rounded-full  transition-all duration-300 hover:border-blue-400 focus-within:border-blue-400">
//                         <svg
//                           width="15"
//                           height="15"
//                           viewBox="0 0 40 40"
...
//             src="https://carltonlondon.co.in/cdn/shop/files/clsw232_3.jpg?v=1684318860"
//             alt="Product"
//             className="w-full md:w-3/4 lg:w-3/5 rounded-md object-cover"
//           />
...
//       <div className="fixed bottom-0 left-0 w-full sm:hidden bg-white border-t p-4 flex justify-between items-center gap-2 shadow-md">
//         <div className="flex w-[25%] justify-around items-center gap-4 bg-gray-200 py-2 px-4 rounded-md">
//           <p>-</p>
//           <span className="text-gray-400">|</span>
//           <p className="text-lg font-bold">1</p>
//           <span className="text-gray-400">|</span>
